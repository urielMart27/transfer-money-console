...
namespace MoneyTransfer
{
    internal class Person
    {
        ...
        public void DisplayInfo()
        {
            ...
            Console.WriteLine($"{name} has {wallet.money} dollars in their wallet");
        }
        ...
        public bool TransferMoney(Person receiver, int amountToTransfer)
        {
            ...
            if (wallet.money >= amountToTransfer)
            {
                ...
                Console.WriteLine($"{amountToTransfer} was Transferred");
                return true;
            }
            else
            {
                Console.WriteLine("Transfer failed due to insufficient money");
                return false; 
